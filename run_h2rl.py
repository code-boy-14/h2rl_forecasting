"""
Complete training script for H²RL model integrated with SimMTM framework
Fixed to include all required arguments

Usage:
    # Pre-training
    python run_h2rl.py --task_name pretrain --data ETTh1 --model H2RL
    
    # Fine-tuning
    python run_h2rl.py --task_name finetune --data ETTh1 --model H2RL
"""
...
parser = argparse.ArgumentParser(description='H²RL: Heterogeneous Hypergraph Representation Learning')

# Basic config
parser.add_argument('--task_name', type=str, required=True, default='pretrain',
                    help='task name: [pretrain, finetune]')
parser.add_argument('--is_training', type=int, default=1, help='status')
parser.add_argument('--model_id', type=str, default='H2RL', help='model id')
parser.add_argument('--model', type=str, required=True, default='H2RL',
                    help='model name')
...
parser.add_argument('--transfer_checkpoints', type=str, default='ckpt_best.pth',
                    help='checkpoints to use for finetune')
parser.add_argument('--load_checkpoints', type=str, default=None,
                    help='location of model checkpoints')
parser.add_argument('--select_channels', type=float, default=1,
...
parser.add_argument('--lm', type=int, default=3,
                    help='average masking length')
parser.add_argument('--positive_nums', type=int, default=3,
                    help='masking series numbers')
...
from exp.exp_h2rl import Exp_H2RL
Exp = Exp_H2RL
